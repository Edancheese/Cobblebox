...
public class CobbleBox {
    ...
    public CobbleBox(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = CobbleBox.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
